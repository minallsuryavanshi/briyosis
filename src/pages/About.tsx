...
const About = () => {
  ...
  return (
    <div className="min-h-screen pt-24">
      ...
      {/* Company Stats */}
      <section className="section-modern bg-gradient-to-br from-secondary/5 to-accent-orange/5">
      ...
      <section className="section-modern">
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <Card className="card-modern p-12">
              <CardContent className="p-0 text-center">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-secondary to-accent-orange flex items-center justify-center mx-auto mb-8">
      ...
      {/* Company Story */}
      <section className="section-modern bg-gradient-innovation text-white">
        <div className="container mx-auto">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-5xl font-bold mb-8">Our Manufacturing Excellence</h2>
            <div className="text-xl leading-relaxed space-y-6 opacity-90">
              <p>
                Briyosis Softcaps operates from a state-of-the-art 10,000 sq.ft facility 
      ...
      {/* CTA Section */}
      <section className="section-modern bg-gradient-medical text-white">
